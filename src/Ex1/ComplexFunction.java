...
public class ComplexFunction implements complex_function {
	...
	public ComplexFunction (function f1) { // build constructor
		this.head= new Node (null,new Node (f1,null,null,null),null,Operation.None);
	...
	public ComplexFunction (String op, function f1, function f2) { // build constructor
		...
		switch (op) {
		case "plus":
			this.head= new Node (null,new Node (f1,null,null,null), new Node (f2,null,null,null) ,Operation.Plus);
			break;
		case "mul":
			this.head= new Node (null,new Node (f1,null,null,null), new Node (f2,null,null,null) ,Operation.Times);
			break;
		case "div":
			this.head= new Node (null,new Node (f1,null,null,null), new Node (f2,null,null,null) ,Operation.Divid);
			break;
		case "max":
			this.head= new Node (null,new Node (f1,null,null,null), new Node (f2,null,null,null) ,Operation.Max);
			break;
		case "min":
			this.head= new Node (null,new Node (f1,null,null,null), new Node (f2,null,null,null) ,Operation.Min);
			break;
		case "comp":
			this.head= new Node (null,new Node (f1,null,null,null), new Node (f2,null,null,null) ,Operation.Comp);
			break;
		default:
	...
	public void plus(function f1) {
		...
		Node temp = this.head;
		this.head= new Node (null,temp,cf1.head,Operation.Plus);
	}
	...
	public void mul(function f1) {
		ComplexFunction cf1= new ComplexFunction (f1);
		Node temp = this.head;
		this.head= new Node (null,temp,cf1.head,Operation.Times);
	}
	...
	public void div(function f1) {
		ComplexFunction cf1= new ComplexFunction (f1);
		Node temp = this.head;
		this.head= new Node (null,temp,cf1.head,Operation.Divid);
	}
	...
	public void max(function f1) {
		ComplexFunction cf1= new ComplexFunction (f1);
		Node temp = this.head;
		this.head= new Node (null,temp,cf1.head,Operation.Max);
	}
	...
	public void min(function f1) {
		ComplexFunction cf1= new ComplexFunction (f1);
		Node temp = this.head;
		this.head= new Node (null,temp,cf1.head,Operation.Min);
	}
	...
	public void comp(function f1) {
		ComplexFunction cf1= new ComplexFunction (f1);
		Node temp = this.head;
		this.head= new Node (null,temp,cf1.head,Operation.Comp);
	}
